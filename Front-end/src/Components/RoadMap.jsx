            ...
            <div class="min-h-screen ">
                ...
                <div class="min-h-screen flex justify-center">
                    <div class="w-2/3 mx-auto">
                        ...
                        <div class="flex flex-row w-full hover:text-xl">
                            ...
                            <div class="w-2/5 px-2 py-10">
                                <div class="flex flex-col w-full rounded-lg shadow bg-sky-500 px-4 py-5">
                                    ...
                                    <div class="text-white">
                                        ...
                                        Enhanced voting options offer flexibility and fairness.                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="w-2/5 px-2 py-10">
                                <div class="flex flex-col w-full rounded-lg shadow bg-sky-500 px-4 py-5">
                                    ...
                                    <div class="text-white">
                                        ...
                                        The platform evolves with the consensus of DAO members.                                    </div>
                                </div>
                            </div>

                            <div class="w-1/5  flex justify-center">
                                <div class="relative flex h-full w-1 bg-sky-500 items-center justify-center">
                                    <div class="text-white text-2xl absolute flex flex-col justify-center h-24 w-24 rounded-full border-4 border-sky-500 leading-none text-center z-10 bg-sky-800 ">
