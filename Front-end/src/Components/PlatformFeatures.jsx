        ...
        <div id='platformFeatures'>
            ...
            <div className='p-16'>
                ...
                <div className='grid grid-cols-5 xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-2'>
                    <div
                        class="block rounded-lg bg-white/20 hover:bg-white/30 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                        <img
                            class="rounded-t-lg h-48"
                            src="src/img/pf1.jpeg"
                            alt="" />
                        <div class="p-6">
                            <h5
