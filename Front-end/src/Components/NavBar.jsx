  ...
  return (
      ...
      <div className="grid grid-cols-5 gap-2">
        ...
        <div
                            ...
                            <button
                                className="flex items-center bg-gradient-to-r from-blue-500 to-blue-800 hover:bg-gradient-to-bl border-blue-400 text-white font-bold p-5   rounded-lg h-[15%] ">
                                Connect to Phantom
                                <img
